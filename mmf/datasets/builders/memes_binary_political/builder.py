...
from mmf.datasets.builders.memes_binary_political.dataset import (
...
@registry.register_builder("memes_binary_political")
class MemesBuilder(MMFDatasetBuilder):
        # Init should call super().__init__ with the key for the dataset
    def __init__(
        self,
        dataset_name="memes_binary_political",
        dataset_class=MemesBinaryPolDataset,
        *args,
        **kwargs
        ):
    ...
    def load(self, config, dataset_type, *args, **kwargs):
        ...
        if config.use_features:
            self.dataset_class = MemesBinaryPolFeatureDataset
    ...
    def config_path(self):
        return "mmf/configs/datasets/memes_binary_political/defaults.yaml"

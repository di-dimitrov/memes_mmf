...
class MemesBinaryPolFeatureDataset(MMFDataset):
    def __init__(self, config, *args, dataset_name="memes_binary_political", **kwargs):
...
class MemesBinaryPolDataset(MMFDataset):
    def __init__(self, config, *args, dataset_name="memes_binary_political", **kwargs):
        super().__init__(dataset_name, config, *args, **kwargs)
        print(config)
        assert (

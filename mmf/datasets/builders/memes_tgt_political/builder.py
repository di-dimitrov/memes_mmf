...
from mmf.datasets.builders.memes_tgt_political.dataset import (
MemesPoliticalTgtFeatureDataset,
MemesPoliticalTgtDataset,
)
...
class MemesPoliticalTgtBuilder(MMFDatasetBuilder):
    ...
    def __init__(
        self,
        dataset_name="memes_tgt_political",
        dataset_class=MemesPoliticalTgtDataset,
        *args,
        **kwargs
        ):
            super().__init__(dataset_name, dataset_class, *args, **kwargs)
            self.dataset_class = MemesPoliticalTgtDataset
    ...
    def load(self, config, dataset_type, *args, **kwargs):
        ...
        if config.use_features:
            self.dataset_class = MemesPoliticalTgtFeatureDataset
    ...
    def config_path(self):
        return "mmf/configs/datasets/memes_tgt_political/defaults.yaml"
